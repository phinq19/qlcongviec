        ...
        public void Run()
        {
            ...
            while (listforum.Count != 0)
            {
                ...
                try
                {
                    ...
                    {
                        AddStatus(forum.Url, RunStatus.ErrUserName, error);
                        Close();
                        continue;
                    }
                    ...
                    {
                        AddStatus(forum.Url, RunStatus.ErrPassword, error);
                        Close();
                        continue;
                    }
                    ...
                    {
                        AddStatus(forum.Url, RunStatus.ErrLogin, error);
                        Close();
                        continue;
                    }
                    ...
                    {
                        AddStatus(forum.Url, RunStatus.ErrSubject, error);
                        Close();
                        continue;
                    }
                    ...
                    {
                        AddStatus(forum.Url, RunStatus.ErrMessage, error);
                        Close();
                        continue;
                    }
                    // === Step 4 === //
                    ...
                    AddStatus(forum.Url, RunStatus.Success);

                    // === Step 5 === //
                    error = "";
                    if ((error = RunControl(multiforum.Submit)) != string.Empty)
                    {
                        AddStatus(forum.Url, RunStatus.ErrSubmit, error);
                        Close();
                        continue;
                    }
